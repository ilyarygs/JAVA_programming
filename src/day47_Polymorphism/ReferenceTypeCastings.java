...
public class ReferenceTypeCastings {
    ...
    public static void main(String[] args) {
        ...
        //Dog dog2 = new Dog("Max", "Husky", 'M', 3,5, "White");
        //Dog dog3 = dog2;


        Animal animal =  new Dog("Max", "Husky", 'M', 3,5, "White");
        ...
        Animal animal2 = new Cat("Jim", "Scotish", 'M', 3, 1, "White");
        ...
        // ( (Tester)employee ).uniteTest();

       // ( (Developer)employee ).uniteTest();
